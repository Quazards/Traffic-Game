...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""TopSpeed"",
            ""id"": ""941d37a0-8001-48f0-95d7-0c334b5a34af"",
            ""actions"": [
                {
                    ""name"": ""IncreaseSpeed"",
                    ""type"": ""Button"",
                    ""id"": ""33f90add-7517-47bc-ad4e-eb9c023560fd"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""140b73f3-08fe-4b65-820e-e80b324ee9d5"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    // TopSpeed
    private readonly InputActionMap m_TopSpeed;
    private List<ITopSpeedActions> m_TopSpeedActionsCallbackInterfaces = new List<ITopSpeedActions>();
    private readonly InputAction m_TopSpeed_IncreaseSpeed;
    /// <summary>
    /// Provides access to input actions defined in input action map "TopSpeed".
    /// </summary>
    public struct TopSpeedActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public TopSpeedActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "TopSpeed/IncreaseSpeed".
        /// </summary>
        public InputAction @IncreaseSpeed => m_Wrapper.m_TopSpeed_IncreaseSpeed;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_TopSpeed; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="TopSpeedActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(TopSpeedActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="TopSpeedActions" />
        public void AddCallbacks(ITopSpeedActions instance)
        {
            if (instance == null || m_Wrapper.m_TopSpeedActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_TopSpeedActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="TopSpeedActions" />
        private void UnregisterCallbacks(ITopSpeedActions instance)
        {
            @IncreaseSpeed.started -= instance.OnIncreaseSpeed;
            @IncreaseSpeed.performed -= instance.OnIncreaseSpeed;
            @IncreaseSpeed.canceled -= instance.OnIncreaseSpeed;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="TopSpeedActions.UnregisterCallbacks(ITopSpeedActions)" />.
        /// </summary>
        /// <seealso cref="TopSpeedActions.UnregisterCallbacks(ITopSpeedActions)" />
        public void RemoveCallbacks(ITopSpeedActions instance)
        {
            if (m_Wrapper.m_TopSpeedActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="TopSpeedActions.AddCallbacks(ITopSpeedActions)" />
        /// <seealso cref="TopSpeedActions.RemoveCallbacks(ITopSpeedActions)" />
        /// <seealso cref="TopSpeedActions.UnregisterCallbacks(ITopSpeedActions)" />
        public void SetCallbacks(ITopSpeedActions instance)
        {
            foreach (var item in m_Wrapper.m_TopSpeedActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_TopSpeedActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "TopSpeed" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="TopSpeedActions.AddCallbacks(ITopSpeedActions)" />
    /// <seealso cref="TopSpeedActions.RemoveCallbacks(ITopSpeedActions)" />
    public interface ITopSpeedActions
    {
        /// <summary>
